...
DEFINITOINS = {
    ...
    'из чего состоит url': 'протокол(http или https .S-более защищенный за счет ssl серта и шифрования боди), порт(https-443,http-80),квери( начинаются с ? и заканчиваются &) домен-хост, путь , якорь (только один начинается с #).',
